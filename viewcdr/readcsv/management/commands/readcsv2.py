...
from readcsv.models import RowCallDetaiRecord
    ...
    def handle(self, *args, **options):
        ...
        for csvitem in extract_from_csv(path_to_csv_file):
            ...
            if path_to_audio:
                ...
                path = None
            try:
                cdr_uniq = RowCallDetaiRecord.objects.get(
                    uniquedid=csvitem.get('uniquedid'))
                ...
                cdr_uniq = RowCallDetaiRecord.objects.create(
                    uniquedid=csvitem['uniquedid'],
